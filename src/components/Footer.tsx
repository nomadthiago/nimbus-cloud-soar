        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div>
            <div className="flex items-center mb-4">
              <CloudIcon className="h-8 w-8 text-nimbus-light-blue mr-2" />
              <h3 className="text-xl font-bold">Flying Nimbus</h3>
            </div>
            <p className="text-gray-300 mb-6">
              Expert Salesforce consulting services helping businesses soar to new heights.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-4">
              ...
              <li className="flex items-center">
                <Phone className="h-5 w-5 text-nimbus-light-blue mr-3" />
                <a href="tel:+14073357588" className="text-gray-300 hover:text-white">
                  (407) 335-7588
                </a>
              </li>
              <li className="flex items-center">
